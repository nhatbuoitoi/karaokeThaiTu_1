...
public class QuanLyKhachHangJPanel extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        String tenkhachhang = txtmaKH.getText();
...
if (confirm == JOptionPane.YES_OPTION) {
    ...
    private void btnTImActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTImActionPerformed
      ...
      DefaultTableModel model = (DefaultTableModel) tblDanhSach.getModel();
       KhachHangDAO khDAO = new KhachHangDAO();
        try {
            int makhachhang = Integer.parseInt(txtmaKH.getText()); // Lấy mã tài khoản từ JTextField
            ...
            if (kh != null) {
                ...
                JOptionPane.showMessageDialog(this, "Không tìm thấy dịch vụ với mã: " + makhachhang);
            }
    ...
    private void tblDanhSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhSachMouseClicked
        ...
        if (selectedRow != -1) { // Kiểm tra xem có hàng nào được chọn không
            ...
            txtTenKH.setText(tblDanhSach.getValueAt(selectedRow, 2).toString());
            txtDiaChi.setText(tblDanhSach.getValueAt(selectedRow, 4).toString());
            txtSDT.setText(tblDanhSach.getValueAt(selectedRow, 3).toString());
            txtNgaysinh.setText(tblDanhSach.getValueAt(selectedRow, 1).toString());
